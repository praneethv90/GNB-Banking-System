    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card_header">
                    ...
                    <form method="post" name="accountTo" class="form-control text-center" onsubmit="return validateAccount()">
                        <div class="form-group mb-3">
                            <input type="text" name="accountTo" class="form-control text-center">
                            <input type="hidden" class="form-control" name="accountNo" value="<?php echo isset($accountNo) ? htmlspecialchars($accountNo) : ''; ?>">
                            <button type="submit" class="btn btn-info m-2">Verify</button>
                            <a href="creditdebit.php" class="btn btn-danger form-control ">Back</a>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="Functions/fundTransfer.php" method="post" onsubmit="return validateWithdrawal()">
                        <div class="form-group mb-3">
                            <label for="toAccount">To Account</label>
                            <input type="text" id="toAccount" placeholder="To Account" class="form-control" name="toAccount" value="<?php echo $accountRet ?>" readonly>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="type" value="Transfer" class="form-control" readonly name="type">
                        </div>
                        <div id="warningMessage" class="text-danger justify-content-center align-items-center"></div>
